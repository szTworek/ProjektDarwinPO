...
class CrazyAnimalTest {
    ...
    void reproduce() {
        ...
        genomes.add(1);
        Animal animal1 = new CrazyAnimal(position, genomes, specifications.startingEnergyForAnimals(), MapDirection.NORTH, 0);
        Animal animal2 = new CrazyAnimal(position, genomes, specifications.startingEnergyForAnimals(), MapDirection.EAST, 0);
